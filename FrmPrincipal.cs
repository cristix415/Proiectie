...
namespace ProiectareCantari
{
    ...
    {        
        ...
        private void AddCantare(Cantare cantare)
        {
        ...
        private void btnSalveaza_Click(object sender, EventArgs e)
        {
            ...
            var cantare = new Cantare(titlu, versuri, 1);
        ...
        {            
            ...
            foreach (var strofa in cantare.ListaStrofe)
            {
                ...
                lblStrofa.Width = 200;
                lblStrofa.Height = 150;
                lblStrofa.Font = new Font(FontFamily.GenericSansSerif, 12);
        ...
        private void buttonModifica_Click(object sender, EventArgs e)
        {
            ...
            tabControl1.SelectedIndex = 1;
            rtxtCantare.Text = cantare.Cantare.Versuri;
            rtxtCantare.Tag = cantare.Cantare;
        ...
        private void btnModifica_Click(object sender, EventArgs e)
        {
            ...
            var titlu = rtxtCantare.Text.Split(new string[] { "\n" }, StringSplitOptions.None)[0];
            var versuri = rtxtCantare.Text;
            string stringSql = "UPDATE Cantari SET Titlu= @titlu, Versuri = @versuri , FlagBetel = @flagBetel  WHERE Id=" + (rtxtCantare.Tag as Cantare).Id;
